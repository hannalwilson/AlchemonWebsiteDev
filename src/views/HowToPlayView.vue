<template>
    <div>
        ...
        <div class="newPlayer">
            ...
            <img class="zoomIn_1" src="https://alchemon-website-assets.s3.amazonaws.com/assets/archislash.gif" alt="Archislash">
        </div>
        <div class="rules">
            ...
            <img class="zoomIn_1" src="https://alchemon-website-assets.s3.amazonaws.com/assets/vena_evolution.png" alt="Vena Evolutions">
        </div>
        <div class="staking">
            <p class="grayHeader spreadText">STAKING</p>
            <p class="whiteText">Stake your Common or Uncommon Alchemon for 6 days in the Training Grounds Wallet and
                they will evolve to the next level. Supplies in the Staking Wallet are limited, so it will be first
                come, first serve. Your Alchemon that you sent will get evolved, so you will not receive it back, but
                will receive a more powerful version! Make sure you add the asset of the Alchemon you will be receiving.
                Add Alchemon Assets via the AlcheDex page. There are links to add a single asset or multiple assets via
            ...
            <img class="zoomIn_1" src="https://alchemon-website-assets.s3.amazonaws.com/assets/handshake.png" alt="Handshake">
        </div>
        <div class="trading">
            <p class="orangeHeader spreadText">TRADING</p>
            <p>If you can’t wait to stake then it will take some alchemy to get the job done. Trade 2 copies of the SAME
            ...
            <img class="zoomIn_1" src="https://alchemon-website-assets.s3.amazonaws.com/assets/transfer.png" alt="Transfer">
        </div>
        <div class="deflationary">
            <p class="grayHeader spreadText">DEFLATIONARY</p>
            <p class="whiteText">Alchemon is a Deflationary NFT Collecting Card Game. All Staking Evolutions, Trading
                Evolutions and Crafting Swaps have the Alchemon come back home to be redistributed to other players that
                want to do the same. 100% of all Commons go back on sale in the <a class="blueLinks"
                    href="https://www.randgallery.com/algo-collection/?address=ALCHY5SJXOXZXADZPD73KO6CYNZXDUWFYANTSXU6RIO3EZACIIXUCS3YDM"
                    target="_blank">Alchemon Rand Store</a>. This is to make it easier for new players to get started &
                ...
                store.</p>
            <img class="zoomIn_1" src="https://alchemon-website-assets.s3.amazonaws.com/assets/deflationary.png" alt="Deflation">
        </div>
        <div class="crafting">
            <p class="orangeHeader spreadText">CRAFTING</p>
            <p>The first and second Rares of each set combine to make an Epic level Alchemon. The third and fourth
                combine to make another Epic level Alchemon. Combine both unique Epics to craft the rumored Legendary
            ...
            <img class="zoomIn_1" src="https://alchemon-website-assets.s3.amazonaws.com/assets/craft.jpg" alt="Crafting">
        </div>
        ...
        <div class="evolvestake">
            ...
            <img id="trainingAnimation_1" src="https://alchemon-website-assets.s3.amazonaws.com/assets/10_bolt.png" alt="Bolt flipping">
            ...
            <p class="whiteText">You can send the Alchemon you want evolved to this address at any time. 1 Alchemon per
                ...
                for your Alchemon to be turned into. The reserve of available upgrades is kept in the Creator Wallet and
                displayed below so anyone can see them. It is first come, first serve for staked Alchemon to get
            ...
            <img id="trainingAnimation_2" src="https://alchemon-website-assets.s3.amazonaws.com/assets/24_drathslayer.png" alt="Drathslayer flipping">
            <staking-view></staking-view>
        </div>
        <div class="huntinggrounds">
            <p class="whiteHeader spreadText">HUNTING GROUNDS</p>
            <p>A seperate wallet to stake an extra Alchemon for a chance to earn prizes! Stake 1 Alchemon per wallet
                here for 7 days and you earn entries for a raffle! You keep your Alchemon and can pull it out at any
                time with a note on a 0.00 transaction, but only NFT Cards staked from Sunday until the drawing earn you
                entries. The raffle will occur weekly and random winners will get the prizes determined by RNG! Winning
                does not remove your entries, so one wallet can win multiple prizes each week. Good luck, you will need
            ...
            <img id="moveAnimation_2" src="https://alchemon-website-assets.s3.amazonaws.com/assets/hunting_grounds.png" alt="Bat">
            ...
            <img id="moveAnimation_3" src="https://alchemon-website-assets.s3.amazonaws.com/assets/hunting_grounds_1.png" alt="Demo">
        </div>
        <div class="eggs">
            ...
            <img id="loader_text" src="https://alchemon-website-assets.s3.amazonaws.com/assets/Egg.png" alt="Egg">
        </div>
        <div class="distribution">
            <p class="yellowHeader spreadText">DISTRIBUTION</p>
            <p class="whiteText">The Trading and Staking Wallets will always have a moving and changing amount of NFT
                Cards.<br><br>We reserve the ability to rebalance the stock between the two at any time based on
                popularity or demand. Here are the distribution numbers for each released set:<br><br>&#9830; Set 01
