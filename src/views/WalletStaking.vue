<template>
    <div class="stakinginfo">
        ...
        <p class="whiteText marginFix_2">Get paid AlcheCoin just by holding Alchemon in your wallet! In order to receive your weekly staking rewards, you must opt-in to the
            AlcheCoin and Stake Flag Assets. Once a week on Saturday evenings, AlcheCoin will be desposited into your wallet based on the Alchemon you currently hold. The chart
